...
const requiredFiles = [
  ...
  "examples/evidence/production.config.js",
  "docs/evidence.md",
  "schemas/evidence.schema.json",
  "schemas/production-project.schema.json",
  "schemas/production-observations.schema.json",
  "src/production-observe.js",
  "src/production-frames.js",
  "src/production.js",
  "src/production-cli.js",
